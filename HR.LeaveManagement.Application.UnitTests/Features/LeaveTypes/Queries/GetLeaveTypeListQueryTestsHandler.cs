...
{
    public class GetLeaveTypeListQueryTestsHandler
    {
        private readonly Mock<ILeaveTypeRepository> _mockRepo;
        private readonly IMapper _mapper;
        private  Mock<IAppLogger<GetLeaveTypesQueryHandler>> _appLogger;
        public GetLeaveTypeListQueryTestsHandler()
        {
        ...
        {
            var handler = new GetLeaveTypesQueryHandler(_mockRepo.Object, _mapper, _appLogger.Object);
